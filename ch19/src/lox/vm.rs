            ...
            match self.read_byte().code {
                ...
                OpCode::Add => {
                    ...
                    if a.is_string() && b.is_string() {
                        let s = a.as_string().unwrap().to_string() + b.as_string().unwrap();
...
mod tests {
    ...
    fn it_can_compare_strings() {
        assert_interpret(r#""string" == "string""#, &Value::Bool(true));
        assert_interpret(r#""string" != "string""#, &Value::Bool(false));
        assert_interpret(r#""string" != "another string""#, &Value::Bool(true));
        assert_interpret(r#""string" == "another string""#, &Value::Bool(false));
    }
